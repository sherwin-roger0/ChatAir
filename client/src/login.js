  ...
  return(
    <div>
      <ThemeProvider theme={theme}>
        <Nav True={true} name="Sign in" link="/"/>
       <React.Fragment>
         <CssBaseline />
           <Container fixed>
             <Grid direction="column" justify="center" alignItems="center" container spacing={1}>
               <Grid item xs>
                 ...
                 <Typography color="secondary" style={{width: '100%',maxWidth: 500,padding:"1px"}}  align="center" variant="h6" gutterBottom>
                   Log in to get into the Chat room
                 </Typography>
               </Grid>
             ...
             <Grid direction="column" justify="center" alignItems="center" container spacing={1}>
              <Grid item xs>
                    ...
                    <form onSubmit={handleSubmit}>
                      <Grid direction="column" justify="center" alignItems="center" container spacing={1}>
                        <Grid item xs>
                          <br />
                          <TextField inputRef={emailRef}  type="text"  color="primary" label="email" required/>
                          <br />
                        </Grid>
                        <Grid item xs>
                          <br />
                          <TextField inputRef={passRef}  type="password"  color="primary" label="password" required/>
                          <br />
                        </Grid>
                        <Grid item xs>
                          <br />
              ...
              <Grid item xs>
                  <br />
                  Don't have an account ? <Link style={{color:"purple"}} to="/">Sign in</Link>
                  <br />
                  <br />
                  <br />
              </Grid>
